...
const checklistData = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Motion Sickness Pills', description: 'For those prone to car sickness on mountain roads' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Nail Cutter', description: 'Basic grooming tool' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Swimming Shorts (Optional)', description: 'If you plan to swim at Khanpur Dam on return day' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Cash (PKR 10,000-15,000)', description: 'For emergencies, snacks, and personal expenses' },
  ...
  },
  {
    ...
    items: [
      { name: 'Backpack (40-50L)', description: 'One bag per person. Pack light.', critical: true },
      { name: 'Water Bottle (1L)', description: 'Reusable bottle - stay hydrated at altitude', critical: true },
      { name: 'Small Daypack', description: 'For day trips and hikes - leave main bag in car' },
      ...
      { name: 'Portable Clothesline', description: 'For drying wet clothes in hotels' },
    ],
  },
  {
    ...
    items: [
      { name: 'Personal Medication', description: 'Any prescription medicines you take regularly', critical: true },
      { name: 'Pain Relievers (Panadol)', description: 'For headaches, body ache from altitude' },
      { name: 'Altitude Sickness Pills', description: 'Diamox if available - we are going to 8000+ ft elevation' },
      { name: 'Anti-Diarrheal Medicine', description: 'Food changes can upset stomach' },
      { name: 'Band-Aids & Antiseptic', description: 'For minor cuts and scrapes during hikes' },
      { name: 'Antihistamine', description: 'For allergic reactions' },
      { name: 'Cold & Flu Medicine', description: 'Temperature changes can cause illness' },
      { name: 'Throat Lozenges', description: 'Cold air can irritate throat' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'Extra Memory Cards', description: 'You will take LOTS of photos' },
      { name: 'Portable Power Bank (20,000mAh)', description: 'High capacity - charging opportunities are limited', critical: true },
      { name: 'Universal Charger', description: 'For all your devices' },
